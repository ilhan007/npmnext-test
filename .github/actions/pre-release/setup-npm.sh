...
echo "//registry.npmjs.org/:username=${NPM_USERNAME}" >> ./packages/main/.npmrc
echo "//registry.npmjs.org/:email=${NPM_EMAIL}" >> ./packages/main/.npmrc
echo "//registry.npmjs.org/:_authToken=${NPM_AUTH_TOKEN}" >> ./packages/main/.npmrc
